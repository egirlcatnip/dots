...
install_repos() {
  ...
  sudo dnf install -y --nogpgcheck --repofrompath 'rpmfusion-free,https://download1.rpmfusion.org/free/fedora/releases/$releasever/Everything/$basearch/os' rpmfusion-free-release || log_warn "Failed to enable RPM Fusion Free repository"
