...
install_repos() {
  ...
  sudo dnf install --nogpgcheck --repofrompath 'rpmfusion-free,https://download1.rpmfusion.org/free/fedora/releases/$releasever/$basearch' rpmfusion-free || log_warn "Failed to enable RPM Fusion Free repository"

  log_info "Enabling RPM Fusion Non-Free repository"
  sudo dnf install --nogpgcheck --repofrompath 'rpmfusion-nonfree,https://download1.rpmfusion.org/nonfree/fedora/releases/$releasever/$basearch/' rpmfusion-nonfree || log_warn "Failed to enable RPM Fusion Non-Free repository"
}
