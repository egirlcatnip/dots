...
install_repos() {
  ...
  sudo dnf install -y --nogpgcheck --repofrompath 'rpmfusion-free,https://download1.rpmfusion.org/free/fedora/releases/$releasever/Everything/$basearch/os' rpmfusion-free-release \
    || log "$WARN" "Failed to enable RPM Fusion Free repository"

  sudo dnf install -y --nogpgcheck --repofrompath 'rpmfusion-nonfree,https://download1.rpmfusion.org/nonfree/fedora/releases/$releasever/Everything/$basearch/os' rpmfusion-nonfree-release \
