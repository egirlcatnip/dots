...
install_repos() {
  ...
  sudo dnf install --nogpgcheck --repofrompath 'rpmfusion-nonfree,https://download1.rpmfusion.org/nonfree/fedora/releases/$releasever/Everything/$basearch/os' rpmfusion-nonfree-release || log_warn "Failed to enable RPM Fusion Non-Free repository"
}
