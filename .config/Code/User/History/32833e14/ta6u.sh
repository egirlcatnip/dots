...
install_repos() {
  ...
  sudo dnf install --nogpgcheck --repofrompath 'rpmfusion-free,rpmfusion-nonfree,https://download1.rpmfusion.org/free/fedora/releases/$releasever/Everything/$basearch/os' rpmfusion-free-release || log_warn "Failed to enable RPM Fusion Free repository"

  log_info "Enabling RPM Fusion Non-Free repository"
  sudo dnf install --nogpgcheck --repofrompath 'rpmfusion-nonfree,rpmfusion-nonfree,https://download1.rpmfusion.org/nonfree/fedora/releases/$releasever/Everything/$basearch/os' rpmfusion-nonfree-release || log_warn "Failed to enable RPM Fusion Non-Free repository"
}
